...
const NumberOption = ({ productInfo, itemIndex, setProductInfo, productOptionsMemo, setProductOptionsMemo }) => {
    ...
    const handleProductInfoMinValue = (e) => {
        const arrayCopy = productInfo.options;
    ...
    const handleDummyValueChange = (prop) => (event) => {
        // var roundedNumber = 0;
        var unit = productInfo.options[itemIndex].fiststItemUnit;
        var min = productInfo.options[itemIndex].fistItemMinValue;
        var max = productInfo.options[itemIndex].firstItemMaxValue;
    ...
    const handleProductInfoUnit = (e) => {
        const arrayCopy = productInfo.options;
        arrayCopy[itemIndex].fiststItemUnit = e.target.value;
        setProductInfo({ ...productInfo, options: arrayCopy});
    };

    const handleProductInfoadditionalPrice = (e) => {
        const arrayCopy = productInfo.options;
                                        ...
                                        <Grid item xl={6} lg={6} md={12} sm={12} xs={12} >
                                            ...
                                            <ButtonGroup variant="contained" aria-label="outlined primary button group" classes={{root: classes.previewButtonGroup}}>
                                                <Button 
                                                    ...
                                                    onClick={handleDummyValueChange('+')}
                                                >
                                                +
                                                </Button>
                            ...
                            <Box className={classes.item}>
                                ...
                                <FormControl className={classes.formVariantOptionNameInfo} variant="outlined">
                                    <OutlinedInput
                                        ...
                                        onChange={(e) => handleProductInfoMinValue(e)}
                                        classes={{root: classes.textInput, notchedOutline: classes.diasbleOutline }}
                                        autoComplete='off'
                                    />
                                </FormControl> 
                            ...
                            <Box className={classes.item}>
                                ...
                                <FormControl className={classes.formVariantOptionNameInfo} variant="outlined">
                                    <OutlinedInput
                                        ...
                                        onChange={(e) => handleProductInfoMaxValue(e)}
                                        classes={{root: classes.textInput, notchedOutline: classes.diasbleOutline }}
                                        autoComplete='off'
                                    />
                                </FormControl> 
                            ...
                            <Box className={classes.item}>
                                ...
                                <FormControl className={classes.formVariantOptionNameInfo} variant="outlined">
                                    <OutlinedInput
                                        ...
                                        onChange={(e) => handleProductInfoUnit(e)}
                                        classes={{root: classes.textInput, notchedOutline: classes.diasbleOutline }}
                                        autoComplete='off'
                                    />
                                </FormControl> 
                            ...
                            <Box className={classes.item}>
                                ...
                                <FormControl className={classes.formVariantOptionNameInfo} variant="outlined">
                                    <OutlinedInput
                                        ...
                                        onChange={(e) => handleProductInfoadditionalPrice(e)}
                                        classes={{root: classes.textInput, notchedOutline: classes.diasbleOutline }}
                                        autoComplete='off'
                                    />
                                </FormControl> 
